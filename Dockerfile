...
RUN apt update && apt dist-upgrade -y && \
    ...
    echo y | /opt/tools/bin/sdkmanager "system-images;android-24;default;armeabi-v7a" >/dev/null && \
    echo no | /opt/tools/bin/avdmanager create avd --force --name test --package 'system-images;android-24;default;armeabi-v7a'
